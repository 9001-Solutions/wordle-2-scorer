...
for (const letter of allLetters) {
  graph[letter] = { pos0: 0, pos1: 0, pos2: 0, pos3: 0, pos4: 0, pos5: 0 };
}
...
for (const dailyWord of [
  ...allWords.dailyWords,
  ...allWords.guessableWords.filter((gw) => !allWords.dailyWords.includes(gw)),
]) {
...
const getScore = (word) => {
  const score =
    ...
    pos5Rankings.find((r) => r.letter === word[5]).amount;
...
const getSubScore = (word) => {
  return (
    ...
    pos5Rankings.find((r) => r.letter === word[0]).amount +
    //
    ...
    pos5Rankings.find((r) => r.letter === word[1]).amount +
    //
    ...
    pos5Rankings.find((r) => r.letter === word[2]).amount +
    //
    ...
    pos5Rankings.find((r) => r.letter === word[3]).amount +
    //
    ...
    pos5Rankings.find((r) => r.letter === word[4]).amount +
    //
    pos0Rankings.find((r) => r.letter === word[5]).amount +
    pos1Rankings.find((r) => r.letter === word[5]).amount +
    pos2Rankings.find((r) => r.letter === word[5]).amount +
    pos3Rankings.find((r) => r.letter === word[5]).amount +
    pos4Rankings.find((r) => r.letter === word[5]).amount
  );
};
